...
# dataset settings
train_data_path="path/to/your/data/VoiceAssistant-400K-v2/train_with_phn.jsonl"
val_data_path="path/to/your/data/VoiceAssistant-400K-v2/val_with_phn.jsonl"
